...
export const RoleViewContainer: React.FC = () => {
  ...
  // Render Driver Dashboard View when active role is GARAGE_DRIVER, INDEPENDENT_DRIVER, or DRIVER
  if (
  ...
  // Render Passenger Dashboard View when active role is PASSENGER
